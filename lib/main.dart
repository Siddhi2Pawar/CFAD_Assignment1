...
void main() async {
  ...
  final keyApplicationId = 'glqXtJj2emklyvPYGnobA0zKz3EOMyfWmA0wUdZV';
  final keyClientKey = '10OuQQlTYKk7OZFzbsAKfmwmSQDLijXEWBH7MF7Q';
...
class _HomeState extends State<Home> {
  ...
  Future<void> getTaskList() async {
    ...
    final QueryBuilder<ParseObject> queryTask = QueryBuilder<ParseObject>(ParseObject('Task'))
      ..orderByDescending('TaskcompletedAt')
      ..orderByDescending('TaskcreatedAt')
      ..setAmountToSkip(0);
   ...
   Future<void> updateTask(String id, bool done) async {
    ...
    if (done) {
      ...
      task..set('done', true)..set('TaskcompletedAt', DateTime.now());
    } else {
      task..set('done', false);
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Hurry up..Time is running fast !!!!",
        style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 255, 0))
       ),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Quick Task - Edit', style:
              TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 255, 0, 0))),
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Quick Task - Add', style:
              TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 0, 255, 0))),
        backgroundColor: Colors.red,
        centerTitle: true
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 255, 0, 0))),
            ),
          ],
        ),
      ),
